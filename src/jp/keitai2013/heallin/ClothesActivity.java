...
import jp.keitai2013.heallin.fragment.ClothesFragment;
...
public class ClothesActivity extends SherlockFragmentActivity  {
...
//		Bundle b = getIntent().getExtras();
		...
		tab.setTabListener(new TabListener<ClothesFragment>(
                this, "tag1", ClothesFragment.class, android.R.id.content, args));
