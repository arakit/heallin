...
import jp.keitai2013.heallin.fragment.SearchOfFrendsFragment;
...
//		actionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_TABS);
		...
		String q = b.getString(Const.AK_SEARCH_Q);
		...
		args.putString(Const.AK_SEARCH_Q, q);
		tab.setTabListener(new TabListener<SearchOfFrendsFragment>(
                this, "tag1", SearchOfFrendsFragment.class, android.R.id.content, args));
